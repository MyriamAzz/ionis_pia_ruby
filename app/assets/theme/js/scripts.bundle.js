/******/ (() => {
            ...
            var Plugin = {
                ...
                var lock = {
                  ...
                  enable: function () {
                    var enableLock = function (tablePart) {
                      ...
                      if (
                        $(tablePart).find("." + pfx + "datatable-lock").length >
                        0
                      ) {
                        Plugin.log(
                    ...
                    $(datatable.table)
                      ...
                      .each(function () {
                        var tablePart = this;
                        if (
                          $(this).find("." + pfx + "datatable-lock").length ===
                          0
                        ) {
                          $(this).ready(function () {
                ...
                $(datatable.tableBody)
                  ...
                  .on("mouseenter", function () {
                    ...
                    $(row)
                      ...
                      .parent()
                      .find(
                        "." + pfx + "datatable-row:nth-child(" + index + ")"
                      )
                      .addClass(pfx + "datatable-row-hover");
                  })
              ...
              setupSystemColumn: function () {
                      ...
                      .each(function (tdi, td) {
                        ...
                        if (typeof column !== "undefined") {
                          ...
                          if (
                            ...
                            var chk = $("<label/>")
                              .addClass(
                                pfx + "checkbox " + pfx + "checkbox-single"
                              )
                              .append(
                                $("<input/>")
                                  .attr("type", "checkbox")
                ...
                var initCheckbox = function (tr) {
                  ...
                  var column = $.grep(columns, function (n, i) {
                    return (
                      typeof n.selector !== "undefined" && n.selector !== false
                    );
                  })[0];
                ...
                var scroll = {
                  ...
                  init: function () {
                    ...
                    if (options.layout.scroll) {
                      ...
                      if (
                        $(scrollable).find("." + pfx + "datatable-row").length >
                          0 &&
                        $(scrollable).length > 0
                      ) {
              ...
              dataRender: function (action) {
                ...
                var afterGetData = function (result) {
                  var localPagingCallback = function (ctx, meta) {
                    if (
                      !$(ctx.pager).hasClass(pfx + "datatable-paging-loaded")
                    ) {
                      $(ctx.pager).remove();
                      ctx.init(meta);
                    }
              ...
              insertData: function () {
                ...
                $.each(datatable.dataSet, function (rowIndex, row) {
                  ...
                  for (var a = 0; a < colLength; a += 1) {
                    ...
                    if (
                      Plugin.getObject("sort.field", params) === column.field
                    ) {
                  ...
                  populate: function () {
                    ...
                    if (Plugin.getOption("toolbar.items.info")) {
                      pg.pagerLayout["info"] = $("<div/>")
                        ...
                        .append(
                          $("<span/>").addClass(pfx + "datatable-pager-detail")
                        );
                    }
                    ...
                    $(datatable)
                      ...
                      .on(pg.paginateEvent, function (e, meta) {
                        ...
                        $(pg.pager).each(function () {
                          $(this)
                            .find(
                              "." + pfx + 'datatable-pager-input[type="text"]'
                            )
              ...
              dataMapCallback: function (raw) {
                ...
                if (
                  typeof Plugin.getOption("data.source.read.map") === "function"
                ) {
                      ...
                      if (
                        ...
                        $(detailSubTable).append(
                          $('<tr class="' + pfx + 'datatable-row"></tr>')
                            .append(
                              $(
                                '<td class="' + pfx + 'datatable-cell"></td>'
                              ).append($("<span/>").append(column.title))
                            )
                            .append(this)
                        );
                      }
                  ...
                  if (hiddenExist) {
                    ...
                    $(datatable.tableBody)
                      ...
                      .each(function () {
                        // if no toggle yet
                        if (
                          $(this).find("." + pfx + "datatable-toggle-detail")
                            .length === 0
                        ) {
                          // add toggle
                          $(this).prepend(
              ...
              getGeneralSearchKey: function () {
                ...
                return (
                  Plugin.getOption("search.key") || $(searchInput).prop("name")
                );
              },
                  ...
                  .each(function (i, cell) {
                    if (id == $(cell).text()) {
                      ...
                      datatable.API.record = datatable.API.value =
                        Plugin.getOneRow(datatable.tableBody, rowNumber);
                      return datatable;
                    }
                  });
                return datatable;
                    ...
                    if (!options.vars.requestIds) {
                      if ($(this).is(":checked")) {
                        Extension.selectedRows = $.makeArray(
                          $(datatable.tableBody)
                            .find(
                              "." + pfx + 'checkbox-single > [type="checkbox"]'
                            )
                            .map(function (i, chk) {
                              return $(chk).val();
                            })
            ...
            KTUtil.scrollInit(scrollEl, {
              ...
              height: function () {
                ...
                if (KTUtil.isBreakpointDown("lg")) {
                  ...
                  if (cardHeaderEl) {
                    height =
                      height - parseInt(KTUtil.css(cardHeaderEl, "height"));
                    height =
                      height -
                  ...
                  if (cardFooterEl) {
                    height =
                      height - parseInt(KTUtil.css(cardFooterEl, "height"));
                    height =
                      height -
  ...
  \**********************************/
    ...
    window.KTUtil = __webpack_require__(
      /*! @/src/js/components/util.js */ "../demo4/src/js/components/util.js"
    );
    window.KTApp = __webpack_require__(
      /*! @/src/js/components/app.js */ "../demo4/src/js/components/app.js"
    );
    window.KTCard = __webpack_require__(
      /*! @/src/js/components/card.js */ "../demo4/src/js/components/card.js"
    );
    window.KTCookie = __webpack_require__(
      /*! @/src/js/components/cookie.js */ "../demo4/src/js/components/cookie.js"
    );
    window.KTDialog = __webpack_require__(
      /*! @/src/js/components/dialog.js */ "../demo4/src/js/components/dialog.js"
    );
    window.KTHeader = __webpack_require__(
      /*! @/src/js/components/header.js */ "../demo4/src/js/components/header.js"
    );
    window.KTImageInput = __webpack_require__(
      /*! @/src/js/components/image-input.js */ "../demo4/src/js/components/image-input.js"
    );
    window.KTMenu = __webpack_require__(
      /*! @/src/js/components/menu.js */ "../demo4/src/js/components/menu.js"
    );
    window.KTOffcanvas = __webpack_require__(
      /*! @/src/js/components/offcanvas.js */ "../demo4/src/js/components/offcanvas.js"
    );
    window.KTScrolltop = __webpack_require__(
      /*! @/src/js/components/scrolltop.js */ "../demo4/src/js/components/scrolltop.js"
    );
    window.KTToggle = __webpack_require__(
      /*! @/src/js/components/toggle.js */ "../demo4/src/js/components/toggle.js"
    );
    window.KTWizard = __webpack_require__(
      /*! @/src/js/components/wizard.js */ "../demo4/src/js/components/wizard.js"
    );
    __webpack_require__(
      /*! @/src/js/components/datatable/core.datatable.js */ "../demo4/src/js/components/datatable/core.datatable.js"
    );
    __webpack_require__(
      /*! @/src/js/components/datatable/datatable.checkbox.js */ "../demo4/src/js/components/datatable/datatable.checkbox.js"
    );
    __webpack_require__(
      /*! @/src/js/components/datatable/datatable.rtl.js */ "../demo4/src/js/components/datatable/datatable.rtl.js"
    );

    // Metronic layout base js
    window.KTLayoutAside = __webpack_require__(
      /*! @/src/js/layout/base/aside.js */ "../demo4/src/js/layout/base/aside.js"
    );
    window.KTLayoutContent = __webpack_require__(
      /*! @/src/js/layout/base/content.js */ "../demo4/src/js/layout/base/content.js"
    );
    window.KTLayoutFooter = __webpack_require__(
      /*! @/src/js/layout/base/footer.js */ "../demo4/src/js/layout/base/footer.js"
    );
    window.KTLayoutHeader = __webpack_require__(
      /*! @/src/js/layout/base/header.js */ "../demo4/src/js/layout/base/header.js"
    );
    window.KTLayoutHeaderMenu = __webpack_require__(
      /*! @/src/js/layout/base/header-menu.js */ "../demo4/src/js/layout/base/header-menu.js"
    );
    window.KTLayoutHeaderTopbar = __webpack_require__(
      /*! @/src/js/layout/base/header-topbar.js */ "../demo4/src/js/layout/base/header-topbar.js"
    );
    window.KTLayoutStickyCard = __webpack_require__(
      /*! @/src/js/layout/base/sticky-card.js */ "../demo4/src/js/layout/base/sticky-card.js"
    );
    window.KTLayoutStretchedCard = __webpack_require__(
      /*! @/src/js/layout/base/stretched-card.js */ "../demo4/src/js/layout/base/stretched-card.js"
    );
    window.KTLayoutSubheader = __webpack_require__(
      /*! @/src/js/layout/base/subheader.js */ "../demo4/src/js/layout/base/subheader.js"
    );

    // Metronic layout extended js
    window.KTLayoutAdvanceSearch = __webpack_require__(
      /*! @/src/js/layout/extended/advance-search.js */ "../demo4/src/js/layout/extended/advance-search.js"
    );
    window.KTLayoutChat = __webpack_require__(
      /*! @/src/js/layout/extended/chat.js */ "../demo4/src/js/layout/extended/chat.js"
    );
    window.KTLayoutDemoPanel = __webpack_require__(
      /*! @/src/js/layout/extended/demo-panel.js */ "../demo4/src/js/layout/extended/demo-panel.js"
    );
    window.KTLayoutExamples = __webpack_require__(
      /*! @/src/js/layout/extended/examples.js */ "../demo4/src/js/layout/extended/examples.js"
    );
    window.KTLayoutQuickActions = __webpack_require__(
      /*! @/src/js/layout/extended/quick-actions.js */ "../demo4/src/js/layout/extended/quick-actions.js"
    );
    window.KTLayoutQuickCartPanel = __webpack_require__(
      /*! @/src/js/layout/extended/quick-cart.js */ "../demo4/src/js/layout/extended/quick-cart.js"
    );
    window.KTLayoutQuickNotifications = __webpack_require__(
      /*! @/src/js/layout/extended/quick-notifications.js */ "../demo4/src/js/layout/extended/quick-notifications.js"
    );
    window.KTLayoutQuickPanel = __webpack_require__(
      /*! @/src/js/layout/extended/quick-panel.js */ "../demo4/src/js/layout/extended/quick-panel.js"
    );
    window.KTLayoutQuickSearch = __webpack_require__(
      /*! @/src/js/layout/extended/quick-search.js */ "../demo4/src/js/layout/extended/quick-search.js"
    );
    window.KTLayoutQuickUser = __webpack_require__(
      /*! @/src/js/layout/extended/quick-user.js */ "../demo4/src/js/layout/extended/quick-user.js"
    );
    window.KTLayoutScrolltop = __webpack_require__(
      /*! @/src/js/layout/extended/scrolltop.js */ "../demo4/src/js/layout/extended/scrolltop.js"
    );
    window.KTLayoutSearch = window.KTLayoutSearchOffcanvas =
      __webpack_require__(
        /*! @/src/js/layout/extended/search.js */ "../demo4/src/js/layout/extended/search.js"
      );

    __webpack_require__(
      /*! @/src/js/layout/initialize.js */ "../demo4/src/js/layout/initialize.js"
    );
  })();
